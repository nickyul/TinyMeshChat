...
// Encoded size is checked by EnvelopeCodec::encode/decode at the byte boundary.
class MessageCodec {
public:
    ...
    [[nodiscard]] static bool isResponseFor(const QString& requestType, const QString& responseType);
